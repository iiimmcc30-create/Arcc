...
const t = {
  ar: {
    title: 'اللاعبون',
    subtitle: 'نجوم ARC Esports',
    role: 'المركز',
    rank: 'الرتبة',
    achievements: 'الإنجازات',
    empty: 'لم تُضف نجوم ARC بعد — أضفهم من لوحة التحكم.',
  },
  en: {
    title: 'Players',
    subtitle: 'ARC Esports Stars',
    role: 'Role',
    rank: 'Rank',
    achievements: 'Achievements',
    empty: 'No ARC Stars yet — add them from the admin dashboard.',
  },
};
    ...
    <section id="players" dir={isRtl ? 'rtl' : 'ltr'} className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {players.map((player) => {
            const achievements = (lang === 'ar' ? player.achievements : player.achievementsEn) || [];
            return (
              <div
                key={player.id}
              ...
              >
                <div className="relative overflow-hidden aspect-square">
                  {player.image ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-[#0B3C6D] to-[#0D1117] flex items-center justify-center font-display font-900 text-3xl text-white/20">
                ...
                <div className="absolute inset-0 bg-[#0B3C6D]/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-3 text-center">
                  ...
                  <div className="font-mono text-[10px] text-[#F7941D] mb-3">
                    {lang === 'ar' ? player.country : player.countryEn}
                  </div>
